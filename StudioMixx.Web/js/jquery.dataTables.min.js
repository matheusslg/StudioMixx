...
(function (h) {
    ...
    function Fa(a) {
        var b = m.defaults.oLanguage,
            c = a.sZeroRecords;
        !a.sEmptyTable && (c && "Nenhum dado encontrado na tabela" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable");
    ...
    var m = function (a) {
        ...
        this.each(function () {
            ...
            if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                ...
                o.oInit = g;
                r.push(o);
                o.oInstance = 1 === b.length ? b : q.DataTable({ "iDisplayLength": 25 });;
                gb(g);
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "Mostrando de _START_ até _END_ do total de _TOTAL_ resultados",
            sInfoEmpty: "Mostrando de 0 até 0 do total de 0 resultados",
            sInfoFiltered: "(filtrado do total de _MAX_ resultados)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
    ...
    h.extend(m.ext.classes, {
        ...
        sLengthMenu: "dataTables_length_menu",
